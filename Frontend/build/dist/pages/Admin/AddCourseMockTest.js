...
const AddCourseMockTest = () => {
  ...
  const getNextMockTestNumber = async () => {
    try {
      const {data} = await axios.get(`${__SNOWPACK_ENV__.SNOWPACK_PUBLIC_API}/course-mocktest/get-mocktest-number/${params.course}`);
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const {data} = await axios.post(`${__SNOWPACK_ENV__.SNOWPACK_PUBLIC_API}/course-mocktest/add-mocktest/${params.course}`, {questions: mockTestData}, {
        headers: {
