...
const AddLanguageNotes = () => {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const {data} = await axios.post(`${__SNOWPACK_ENV__.SNOWPACK_PUBLIC_API}/language-notes/add-languageNotes/${params.lang}`, formData, {
        headers: {
  ...
  }, /* @__PURE__ */ React.createElement("h1", null, "Create Notes"), /* @__PURE__ */ React.createElement("div", {
    className: "mb-3"
