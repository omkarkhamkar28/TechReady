...
const UpdateCourseNotes = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const {data} = await axios.put(`${__SNOWPACK_ENV__.SNOWPACK_PUBLIC_API}/course-notes/update-single-notes/${params.notes}`, formData, {
        headers: {
  ...
  return /* @__PURE__ */ React.createElement(Layout, {
    title: "Dashboard - Update course notes "
  ...
  }, /* @__PURE__ */ React.createElement("h1", null, "Update Notes"), /* @__PURE__ */ React.createElement("label", null, "Course Name :"), /* @__PURE__ */ React.createElement("input", {
    value: course,
