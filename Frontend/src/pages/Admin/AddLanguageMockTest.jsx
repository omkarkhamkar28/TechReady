...
const AddLanguageMockTest = () => {
    ...
    const getNextMockTestNumber = async () => {
        try {
            const { data } = await axios.get(`http://localhost:3001/language-mocktest/get-mocktest-number/${params.lang}`);
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(
                `http://localhost:3001/language-mocktest/add-mocktest/${params.lang}`,
