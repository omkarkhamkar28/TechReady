...
const UpdateTechnology = () => {
  ...
  const getSingleTechnology = async () => {
    try {
      const { data } = await axios.get(`http://localhost:3001/technology/get-single-technology/${params.id}`);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(`http://localhost:3001/technology/update-technology/${params.id}`, technologyData);
      if (data?.success) {
