...
const AddCourseMockTest = () => {
    ...
    const getNextMockTestNumber = async () => {
        try {
            const { data } = await axios.get(`http://localhost:3001/course-mocktest/get-mocktest-number/${params.course}`);
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(
                `http://localhost:3001/course-mocktest/add-mocktest/${params.course}`,
