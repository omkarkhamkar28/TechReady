    ...
    const getSingleMocktest = async () => {
        try {
            const { data } = await axios.get(
                `http://localhost:3001/language-mocktest/get-single-mocktest/${params.mocktest}`
            );
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.put(
                `http://localhost:3001/language-mocktest/update-mocktest/${params.lang}/${params.mocktest}`,
