...
const UpdateCourseDetails = () => {
    ...
    const getSingleCourse = async () => {
        try {
            const { data } = await axios.get(`http://localhost:3001/course/get-single-course/${params.course}`);
    ...
    const getCourseNotes = async () => {
        try {
            const { data } = await axios.get(`http://localhost:3001/course-notes/get-single-courseNotes/${params.course}`);
            setNotes(data.notes);
        }
        catch (err) {
            console.error(err);
    ...
    const getCourseVideo = async () => {
        try {
            const { data } = await axios.get(`http://localhost:3001/course-video/get-single-courseVideo/${params.course}`);
            setVideo(data.Video);
        }
        catch (err) {
            console.error(err);
    ...
    const getCourseMockTest = async () => {
        try {
            const { data } = await axios.get(`http://localhost:3001/course-mocktest/get-mocktest/${params.course}`);
            ...
            <span className="m-1">
                ...
                <button
                    onClick={async () => {
                        ...
                        try {
                            const response = await axios.delete(`http://localhost:3001/course-notes/delete-single-notes/${id}`);
            ...
            <span className="m-1">
                ...
                <button
                    onClick={async () => {
                        toast.dismiss(t.id); // Dismiss confirmation toast
                        try {
                            const response = await axios.delete(`http://localhost:3001/course-video/delete-courseVideo/${id}`);
                            console.log("Delete Response:", response.data); // Debugging
            ...
            <span className="m-1">
                ...
                <button
                    onClick={async () => {
                        toast.dismiss(t.id); // Dismiss confirmation toast
                        try {
                            const response = await axios.delete(`http://localhost:3001/course-mocktest/delete-mocktest/${id}`);
                            console.log("Delete Response:", response.data); // Debugging
