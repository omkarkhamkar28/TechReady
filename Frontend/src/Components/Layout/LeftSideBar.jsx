...
const LeftSideBar = () => {
  ...
  const getAllLanguages = async () => {
    try {
      const { data } = await axios.get("http://localhost:3001/language/get-language");
      if (data?.success) {
  ...
  const getAllNotes = async () => {
    try {
      const { data } = await axios.get("http://localhost:3001/language-notes/get-languageNotes");
      if (data?.success) {
        setNotes(data?.notes);
      }
    } catch (error) {
  ...
  const getAllLanguageMocktest = async () => {
    try {
      const { data } = await axios.get("http://localhost:3001/language-mocktest/get-mocktest");
      if (data?.success) {
  ...
  const getAllTechnology = async () => {
    try {
      const { data } = await axios.get("http://localhost:3001/technology/get-technology");
